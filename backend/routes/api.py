...
def predict_gesture():
    ...
    try:
        ...
        # Log translation to database history if prediction is highly confident and valid
        history_id = None
        if gesture_name not in ["Uncertain", "Model Not Loaded"]:
            history_id = db_manager.add_history_entry(gesture_name, confidence, spoken=0)
