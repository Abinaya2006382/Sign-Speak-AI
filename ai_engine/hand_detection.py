...
class HandDetector:
    ...
    def process_frame(self, frame_bgr):
        ...
        # 1. Extract raw landmarks for frontend drawing
        raw_landmarks = []
        ...
        # 2. Extract and normalize coordinates for AI model classification
        # We need relative coordinates: subtract the wrist coordinates (landmark 0) from all other landmarks
        ...
        # Scale coordinates: divide by the maximum absolute coordinate value to bound landmarks within [-1.0, 1.0]
